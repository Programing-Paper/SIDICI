            ...
            <form method="POST" class="form">
                        ...
                        <select required name="id_estadoemp" id="id_estadoemp" class='form-control'>
                            ...
                            foreach ($result1 as $res) { ?>
                                <option value="<?php echo $res->id_estadoemp ?>" <?php
                                                                                    if ($result->id_estadoemp == $res->id_estadoemp) {
                                                                                        echo "selected";
                                                                                    } ?>>
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" value='<?php echo $result->nombre; ?>' required name="nombre" id="nombre" placeholder="Nombre" class="form-control" minlenght="10" maxlength="20">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="direccion">Dirección</label>
                        <input value="<?php echo $result->direccion; ?>" required name="direccion" type="text" id="direccion" placeholder="Direccion" class="form-control" minlenght="10" maxlength="150">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="telefono">Teléfono</label>
                        <input value="<?php echo $result->telefono; ?>" required name="telefono" type="text" id="telefono" placeholder="Telefono" class="form-control" minlenght="10" maxlength="20">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <select required name="id_compania" id="id_compania" class='form-control'>
                            ...
                            foreach ($result1 as $res) { ?>
                                <option value="<?php echo $res->id_compania ?>" <?php
                                                                                if ($result->id_compania == $res->id_compania) {
                                                                                    echo "selected";
                                                                                } ?>>
                        ...
                        <select required name="id_cargo" id="cargo" class='form-control'>
                            ...
                            foreach ($result0 as $res) { ?>
                                <option value="<?php echo $res->id_cargo ?>" <?php
                                                                                if ($result->id_cargo == $res->id_cargo) {
                                                                                    echo "selected";
                                                                                } ?>>
